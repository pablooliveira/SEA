...
\itms{
  ...
  \item Site du cours: \url{http://tahiti.prism.uvsq.fr/os/}
  \ittms{
...
\itms{
  ...
  \item Chargés TD: \texttt{chadi.akel@exascale-computing.eu}, \texttt{michel.popov@exascale-computing.eu}
  ...
  \item Dates clés:
  \ittms{
    \item Cours: Lundi 8h00-9h30 salle 113
    \item TDs: Lundi 9h45-12h45 salles 116/117
  }
  \item Contrôle Continu
  \ittms{
    \item Contrôle en fin de semestre
    \item QCMs en début de cours
    \item Certains rendus de TDs notés
  }
}
\end{slide}
...
\pause
  \ittms{
    ...
    \item Écraser la mémoire d'autres processus pour les faire crasher
  }
...
\begin{slide}{SE Multi Utilisateurs}
  ...
  \item Idée:  Avec $N$ utilisateurs, système n'est pas forcément $N$ fois plus lent
    ...
    \item Tous les programmes n'ont pas besoin de la même ressource simultanéement
    }
...
\item Médiation:
\ittms{
  \item OS est le médiateur entre les processus et les ressources
...
\ittms{
  \item Applications tourne en \emph{mode utilisateur}
...
\itms{
  ...
  \ittms{
    ...
    \item Donne et vérifie qui accède au matériel
  }
}
\end{frame}
...
\begin{slide}{Protection Mémoire (2/2)}
  ...
  \item L'OS peut marquer comme invalides certaines adresses virtuelles
  \ittms{
  ...
  \item L'OS peut marquer certaines adressses comme lecture seule
    \ittms{
  ...
  \item L'OS peut marquer certaines adresses comme non exécutables
  \ittms{
